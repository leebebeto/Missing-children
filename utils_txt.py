...
def make_analysis_folder2(tst_data_dir, img_list_1, img_list_2, labels, best_pred, best_similarities, transform,
    ...
    for i in range(len(TP) // 2):
        ...
        img3 = Image.open(os.path.join('/home/nas1_userE/Face_dataset/AgeDB_align', "/".join(a)))
        img4 = Image.open(os.path.join('/home/nas1_userE/Face_dataset/AgeDB_align', "/".join(b)))
