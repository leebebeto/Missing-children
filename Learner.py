...
#             self.scheduler = optim.lr_scheduler.ReduceLROnPlateau(self.optimizer, patience=40, verbose=True)
    ...
    def save_best_state(self, conf, accuracy, to_save_folder=False, extra=None, model_only=False):
        ...
        torch.save(
            ...
            ('lfw_best_model_{}_accuracy:{}_step:{}_{}.pth'.format(get_time(), accuracy, self.step, extra)))
        if not model_only:
            torch.save(
                self.head.state_dict(), save_path /
                ('lfw_best_head_{}_accuracy:{}_step:{}_{}.pth'.format(get_time(), accuracy, self.step, extra)))
            torch.save(
            ...
            for imgs, labels in tqdm(iter(self.loader)):
                ...
                if self.step % self.save_every == 0 and self.step != 0:
                    ...
                    if accuracy > best_accuracy:
                        ...
                        self.save_best_state(conf, accuracy)
